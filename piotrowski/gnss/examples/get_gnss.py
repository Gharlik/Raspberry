...
def loop():
  ...
  print("latutide degree = " + str(lat_lon.latitude_degree) + "   direction = " + lat_lon.lon_direction)
  print("lonutide degree = " + str(lat_lon.lonitude_degree) + "   direction = " + lat_lon.lat_direction)
  print("alt = " + str(alt))
  print("sog = " + str(sog) + " N")
  print("cog = " + str(cog) + " T")
  print("")
